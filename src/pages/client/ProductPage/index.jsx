        ...
        <>
            <div className="bg-neutral-100">
                <div className="container mx-auto px-3 py-1">
                    <ul className="flex items-center py-1.5 text-neutral-600">
                        ...
                        <li className="h-5 text-sm">
                            <a href="" className="hover:text-neutral-800 mx-1 font-normal text-[12px] leading-5 text-neutral-900">
                                Thuốc
                            </a>
                        </li>
                    </ul>
            ...
            <div className="container mx-auto p-3">
                ...
                <div className="grid grid-cols-8 mt-5 items-start gap-5">
                    <a href="" className="flex flex-col items-center justify-center text-center">
                        <div className="bg-blue-50 overflow-hidden size-30 rounded-full border border-blue-100">
                            <img
            ...
            <div className="container relative grid grid-cols-1 md:grid-cols-5 mx-auto items-start gap-3">
                <div className="col-span-1 pt-4">
                    <form className="sticky top-0">
                        <div className="flex items-center justify-between py-4 px-3">
                            ...
                            <button
                                className="relative justify-center border-0 bg-transparent text-sm font-normal text-blue-500 outline-none md:hover:text-primary-600 md:text-base inline"
                                type="reset"
                            >
                                Thiết lập lại
                            </button>
                                ...
                                <div className="grid gap-3">
                                    ...
                                    <div className="grid gap-4">
                                        <div className="relative flex">
                                            <input
                                                type="number"
                                                className="w-full border border-neutral-500 outline-none focus:border-blue-500 rounded-md p-2"
                                    ...
                                    <button className="bg-blue-600 hover:bg-blue-500 py-2 rounded-md w-full text-white font-medium">
                                        Áp dụng
                                    </button>
                                    <div className="grid gap-2">
                                        ...
                                        >
                                            <input type="radio" name="range" id="range1" value={100000} />
                                        ...
                                        <label
                                            ...
                                            className="group flex items-center cursor-pointer gap-3"
                                        >
                                            <input type="radio" name="range" id="range2" value={100000 - 300000} />
                                            <span className="truncate">100.000&nbsp;₫ - 300.000&nbsp;₫</span>
                                        </label>
                                        <label
                                            htmlFor="range3"
                                            className="group flex items-center cursor-pointer gap-3"
                                        >
                                            <input type="radio" name="range" id="range3" value={300000 - 500000} />
                                            <span className="truncate">300.000&nbsp;₫ - 500.000&nbsp;₫</span>
                                        </label>
                                        <label
                                            htmlFor="range4"
                                            className="group flex items-center cursor-pointer gap-3"
                                        >
                                            <input type="radio" name="range" id="range4" value={500000} />
                ...
                <div className="col-span-4 pt-4">
                    <div className="sticky flex items-center gap-3 py-2 top-0">
                        <div class="hidden text-sm font-medium text-neutral-900 md:block">Sắp xếp theo: </div>
                    ...
                    <div className="grid grid-col-2 md:grid-cols-4"></div>
                </div>
            </div>
        </>
    );
