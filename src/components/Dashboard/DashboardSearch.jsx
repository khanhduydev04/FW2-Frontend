      ...
      <div className="bg-white rounded-full shadow-[10px_10px_20px_rgba(218,_213,_213,_0.15)] p-2 w-full flex items-center ">
        <div className="flex-1 px-5">
          <input
            ...
            className="w-full text-sm bg-transparent placeholder:text-text4 focus:outline-none"
          />
        </div>
        <button className="w-[72px] rounded-full bg-primary h-10 flex items-center justify-center flex-shrink-0">
          <svg
